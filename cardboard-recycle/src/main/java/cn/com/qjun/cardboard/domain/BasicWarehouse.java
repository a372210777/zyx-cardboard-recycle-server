...
public class BasicWarehouse implements Serializable {
    private static final long serialVersionUID = -3725084956389796394L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "`id`")
    @ApiModelProperty(value = "仓库编码，修改时必填")
    private Integer id;
    ...
    @NotBlank
    @ApiModelProperty(value = "仓库状态，数据字典：warehouse_status", required = true)
